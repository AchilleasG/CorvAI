...
def _load_credentials() -> Credentials:
    ...
    """
    json_blob = os.getenv("GOOGLE_CALENDAR_CREDENTIALS_JSON")
    json_path = os.getenv("GOOGLE_CALENDAR_CREDENTIALS_FILE")
    delegated_user = os.getenv("GOOGLE_CALENDAR_DELEGATED_USER")
